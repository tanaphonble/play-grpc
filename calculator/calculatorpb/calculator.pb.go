...
type PrimeNumberDecomositionRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PrimeNumberDecomositionRequest) Reset() {
	*x = PrimeNumberDecomositionRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *PrimeNumberDecomositionRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PrimeNumberDecomositionRequest) ProtoMessage() {}

func (x *PrimeNumberDecomositionRequest) ProtoReflect() protoreflect.Message {
	mi := &file_calculator_calculatorpb_calculator_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PrimeNumberDecomositionRequest.ProtoReflect.Descriptor instead.
func (*PrimeNumberDecomositionRequest) Descriptor() ([]byte, []int) {
	return file_calculator_calculatorpb_calculator_proto_rawDescGZIP(), []int{2}
}

func (x *PrimeNumberDecomositionRequest) GetNumber() int64 {
	if x != nil {
		return x.Number
	}
	return 0
...
type PrimeNumberDecomositionResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PrimeNumberDecomositionResponse) Reset() {
	*x = PrimeNumberDecomositionResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *PrimeNumberDecomositionResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PrimeNumberDecomositionResponse) ProtoMessage() {}

func (x *PrimeNumberDecomositionResponse) ProtoReflect() protoreflect.Message {
	mi := &file_calculator_calculatorpb_calculator_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PrimeNumberDecomositionResponse.ProtoReflect.Descriptor instead.
func (*PrimeNumberDecomositionResponse) Descriptor() ([]byte, []int) {
	return file_calculator_calculatorpb_calculator_proto_rawDescGZIP(), []int{3}
}

func (x *PrimeNumberDecomositionResponse) GetPrimeFactor() int64 {
	if x != nil {
...
var file_calculator_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x73,
	0x75, 0x6d, 0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x09, 0x73, 0x75, 0x6d, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x38, 0x0a, 0x1e, 0x50, 0x72,
	0x69, 0x6d, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x44, 0x65, 0x63, 0x6f, 0x6d, 0x6f, 0x73,
	...
	0x6d, 0x62, 0x65, 0x72, 0x22, 0x44, 0x0a, 0x1f, 0x50, 0x72, 0x69, 0x6d, 0x65, 0x4e, 0x75, 0x6d,
	0x62, 0x65, 0x72, 0x44, 0x65, 0x63, 0x6f, 0x6d, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x70, 0x72, 0x69, 0x6d, 0x65,
	0x5f, 0x66, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x70,
	0x72, 0x69, 0x6d, 0x65, 0x46, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x32, 0xc5, 0x01, 0x0a, 0x11, 0x43,
	...
	,
...
var file_calculator_calculatorpb_calculator_proto_goTypes = []interface{}{
	...
	(*PrimeNumberDecomositionRequest)(nil),  // 2: calculator.PrimeNumberDecomositionRequest
	(*PrimeNumberDecomositionResponse)(nil), // 3: calculator.PrimeNumberDecomositionResponse
}
var file_calculator_calculatorpb_calculator_proto_depIdxs = []int32{
	...
	2, // 1: calculator.CalculatorService.PrimeNumberDecomosition:input_type -> calculator.PrimeNumberDecomositionRequest
	1, // 2: calculator.CalculatorService.Sum:output_type -> calculator.sumResponse
	3, // 3: calculator.CalculatorService.PrimeNumberDecomosition:output_type -> calculator.PrimeNumberDecomositionResponse
...
func file_calculator_calculatorpb_calculator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_calculator_calculatorpb_calculator_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PrimeNumberDecomositionRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_calculator_calculatorpb_calculator_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PrimeNumberDecomositionResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type CalculatorServiceClient interface {
	...
	PrimeNumberDecomosition(ctx context.Context, in *PrimeNumberDecomositionRequest, opts ...grpc.CallOption) (CalculatorService_PrimeNumberDecomositionClient, error)
}
...
func (c *calculatorServiceClient) PrimeNumberDecomosition(ctx context.Context, in *PrimeNumberDecomositionRequest, opts ...grpc.CallOption) (CalculatorService_PrimeNumberDecomositionClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CalculatorService_serviceDesc.Streams[0], "/calculator.CalculatorService/PrimeNumberDecomosition", opts...)
	if err != nil {
		return nil, err
	}
	x := &calculatorServicePrimeNumberDecomositionClient{stream}
...
type CalculatorService_PrimeNumberDecomositionClient interface {
	Recv() (*PrimeNumberDecomositionResponse, error)
	grpc.ClientStream
}

type calculatorServicePrimeNumberDecomositionClient struct {
	grpc.ClientStream
}

func (x *calculatorServicePrimeNumberDecomositionClient) Recv() (*PrimeNumberDecomositionResponse, error) {
	m := new(PrimeNumberDecomositionResponse)
...
type CalculatorServiceServer interface {
	...
	PrimeNumberDecomosition(*PrimeNumberDecomositionRequest, CalculatorService_PrimeNumberDecomositionServer) error
}
...
func (*UnimplementedCalculatorServiceServer) PrimeNumberDecomosition(*PrimeNumberDecomositionRequest, CalculatorService_PrimeNumberDecomositionServer) error {
	return status.Errorf(codes.Unimplemented, "method PrimeNumberDecomosition not implemented")
}
...
func _CalculatorService_PrimeNumberDecomosition_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(PrimeNumberDecomositionRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CalculatorServiceServer).PrimeNumberDecomosition(m, &calculatorServicePrimeNumberDecomositionServer{stream})
}

type CalculatorService_PrimeNumberDecomositionServer interface {
	Send(*PrimeNumberDecomositionResponse) error
	grpc.ServerStream
}

type calculatorServicePrimeNumberDecomositionServer struct {
	grpc.ServerStream
}

func (x *calculatorServicePrimeNumberDecomositionServer) Send(m *PrimeNumberDecomositionResponse) error {
...
var _CalculatorService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "PrimeNumberDecomosition",
			Handler:       _CalculatorService_PrimeNumberDecomosition_Handler,
			ServerStreams: true,
		},
	},
